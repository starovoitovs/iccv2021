...
if __name__ == '__main__':
    ...
    signatures = FunctionTransformer(calculate_spatial_signatures, kw_args=dict(tuple_size=TUPLE_SIZE, signature_degree=SIGNATURE_DEGREE))
    reshape = FunctionTransformer(lambda inputs: inputs.reshape((inputs.shape[0] * inputs.shape[1], -1)))
